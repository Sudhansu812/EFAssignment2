...
namespace EFAssignment1.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StaffId,StaffName")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StaffId,StaffName")] Staff staff)
        {
            if (ModelState.IsValid)
            {
